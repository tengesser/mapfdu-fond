; MAPF/DU corridor problem (FOND version) with 4 agents and 12 nodes
...
(define (problem mapfdu_4_12)
  ...
  (:init (adj c00 c01)
         ...
         (goal w0 a0 c00) (goal w0 a1 c01) (goal w0 a2 c04) (goal w0 a3 c07)
         (goal w1 a0 x01) (goal w1 a1 c01) (goal w1 a2 c04) (goal w1 a3 c07)
         (goal w2 a0 c00) (goal w2 a1 x04) (goal w2 a2 c04) (goal w2 a3 c07)
         (goal w3 a0 x01) (goal w3 a1 x04) (goal w3 a2 c04) (goal w3 a3 c07)
         (goal w4 a0 c00) (goal w4 a1 c01) (goal w4 a2 x07) (goal w4 a3 c07)
         (goal w5 a0 x01) (goal w5 a1 c01) (goal w5 a2 x07) (goal w5 a3 c07)
         (goal w6 a0 c00) (goal w6 a1 x04) (goal w6 a2 x07) (goal w6 a3 c07)
         (goal w7 a0 x01) (goal w7 a1 x04) (goal w7 a2 x07) (goal w7 a3 c07)
         (goal w8 a0 c00) (goal w8 a1 c01) (goal w8 a2 c04) (goal w8 a3 c08)
         (goal w9 a0 x01) (goal w9 a1 c01) (goal w9 a2 c04) (goal w9 a3 c08)
         (goal w10 a0 c00) (goal w10 a1 x04) (goal w10 a2 c04) (goal w10 a3 c08)
         (goal w11 a0 x01) (goal w11 a1 x04) (goal w11 a2 c04) (goal w11 a3 c08)
         (goal w12 a0 c00) (goal w12 a1 c01) (goal w12 a2 x07) (goal w12 a3 c08)
         (goal w13 a0 x01) (goal w13 a1 c01) (goal w13 a2 x07) (goal w13 a3 c08)
         (goal w14 a0 c00) (goal w14 a1 x04) (goal w14 a2 x07) (goal w14 a3 c08)
         (goal w15 a0 x01) (goal w15 a1 x04) (goal w15 a2 x07) (goal w15 a3 c08)
         (des w0) (next-choose))
  (:goal (and (stopped a0) (stopped a1) (stopped a2) (stopped a3)
              (imply (des w0) (and (at a0 c00) (at a1 c01) (at a2 c04) (at a3 c07)))
              (imply (des w1) (and (at a0 x01) (at a1 c01) (at a2 c04) (at a3 c07)))
              (imply (des w2) (and (at a0 c00) (at a1 x04) (at a2 c04) (at a3 c07)))
              (imply (des w3) (and (at a0 x01) (at a1 x04) (at a2 c04) (at a3 c07)))
              (imply (des w4) (and (at a0 c00) (at a1 c01) (at a2 x07) (at a3 c07)))
              (imply (des w5) (and (at a0 x01) (at a1 c01) (at a2 x07) (at a3 c07)))
              (imply (des w6) (and (at a0 c00) (at a1 x04) (at a2 x07) (at a3 c07)))
              (imply (des w7) (and (at a0 x01) (at a1 x04) (at a2 x07) (at a3 c07)))
              (imply (des w8) (and (at a0 c00) (at a1 c01) (at a2 c04) (at a3 c08)))
              (imply (des w9) (and (at a0 x01) (at a1 c01) (at a2 c04) (at a3 c08)))
              (imply (des w10) (and (at a0 c00) (at a1 x04) (at a2 c04) (at a3 c08)))
              (imply (des w11) (and (at a0 x01) (at a1 x04) (at a2 c04) (at a3 c08)))
              (imply (des w12) (and (at a0 c00) (at a1 c01) (at a2 x07) (at a3 c08)))
              (imply (des w13) (and (at a0 x01) (at a1 c01) (at a2 x07) (at a3 c08)))
              (imply (des w14) (and (at a0 c00) (at a1 x04) (at a2 x07) (at a3 c08)))
              (imply (des w15) (and (at a0 x01) (at a1 x04) (at a2 x07) (at a3 c08))))))

; MAPF/DU corridor problem (FOND version) with 3 agents and 6 nodes
...
(define (problem mapfdu_3_6)
  ...
  (:init (adj c00 c01)
         ...
         (goal w0 a0 c00) (goal w0 a1 c01) (goal w0 a2 c02)
         (goal w1 a0 x01) (goal w1 a1 c01) (goal w1 a2 c02)
         (goal w2 a0 c00) (goal w2 a1 x02) (goal w2 a2 c02)
         (goal w3 a0 x01) (goal w3 a1 x02) (goal w3 a2 c02)
         (goal w4 a0 c00) (goal w4 a1 c01) (goal w4 a2 c03)
         (goal w5 a0 x01) (goal w5 a1 c01) (goal w5 a2 c03)
         (goal w6 a0 c00) (goal w6 a1 x02) (goal w6 a2 c03)
         (goal w7 a0 x01) (goal w7 a1 x02) (goal w7 a2 c03)
         (des w0) (next-choose))
  (:goal (and (stopped a0) (stopped a1) (stopped a2)
              (imply (des w0) (and (at a0 c00) (at a1 c01) (at a2 c02)))
              (imply (des w1) (and (at a0 x01) (at a1 c01) (at a2 c02)))
              (imply (des w2) (and (at a0 c00) (at a1 x02) (at a2 c02)))
              (imply (des w3) (and (at a0 x01) (at a1 x02) (at a2 c02)))
              (imply (des w4) (and (at a0 c00) (at a1 c01) (at a2 c03)))
              (imply (des w5) (and (at a0 x01) (at a1 c01) (at a2 c03)))
              (imply (des w6) (and (at a0 c00) (at a1 x02) (at a2 c03)))
              (imply (des w7) (and (at a0 x01) (at a1 x02) (at a2 c03))))))

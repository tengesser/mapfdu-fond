...
(define (problem mapfdu_3_10)
  ...
  (:goal (and (stopped a0) (stopped a1) (stopped a2)
              (imply (des w0) (and (at a0 c00) (at a1 c02) (at a2 c05)))
              (imply (des w1) (and (at a0 x02) (at a1 c02) (at a2 c05)))
              (imply (des w2) (and (at a0 c00) (at a1 x05) (at a2 c05)))
              (imply (des w3) (and (at a0 x02) (at a1 x05) (at a2 c05)))
              (imply (des w4) (and (at a0 c00) (at a1 c02) (at a2 c07)))
              (imply (des w5) (and (at a0 x02) (at a1 c02) (at a2 c07)))
              (imply (des w6) (and (at a0 c00) (at a1 x05) (at a2 c07)))
              (imply (des w7) (and (at a0 x02) (at a1 x05) (at a2 c07))))))
